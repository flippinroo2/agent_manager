...
import { createJobTool, getJobStatusTool, getSystemTechnicalSpecsTool, getSkillBuildingGuideTool, getSkillDetailsTool, createStartHeadlessCodingTool, createGetRepositoryDetailsTool, createFileTool, readFileTool, listFilesTool, deleteFileTool } from './tools.js';
...
export async function getJobAgent() {
  if (!_agent) {
    ...
    const tools = [createJobTool, getJobStatusTool, getSystemTechnicalSpecsTool, getSkillBuildingGuideTool, getSkillDetailsTool, createFileTool, readFileTool, listFilesTool, deleteFileTool];
